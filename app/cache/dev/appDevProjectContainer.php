...
class appDevProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'dbname' => 'namsao1_db', 'user' => 'namsao1_user', 'host' => '127.0.0.1', 'password' => 'XpzPc9JzLE', 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_20c5fb3bf508177ac506f0aa4b5e2ba1d3da8d5ff955ac409cfc57d654f3e83b');
        return $instance;
    }
    ...
    {
        $this->services['sonata.intl.timezone_detector.chain'] = $instance = new \Sonata\IntlBundle\Timezone\ChainTimezoneDetector('Asia/Ho_Chi_Minh');
    ...
    {
        return $this->services['sonata.media.extra.pixlr'] = new \Sonata\MediaBundle\Extra\Pixlr('Demo - Sonata Project', 'f40809f3a156f91ae89edc1923b37e329fa17e80', $this->get('sonata.media.pool'), $this->get('sonata.media.manager.media'), $this->get('cmf_routing.router'), $this->get('templating'), $this);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'namsao1_db',
            'database_user' => 'namsao1_user',
            'database_password' => 'XpzPc9JzLE',
